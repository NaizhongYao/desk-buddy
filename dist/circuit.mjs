export const definitions=[
 ...
 {id:'amp',name:'MAX98357A',detail:'功放 · 接线预览',color:'#982972',model:2,pos:[-26,-28],pins:[...['LRC','BCLK','DIN','GAIN','SD','GND','Vin'].map((n,i)=>[n,(i-3)*2.54,-8.35]),['-',-2.05,10],['+',2.05,10]]},
 {id:'mic',name:'MSM3526',detail:'麦克风 · 接线预览',color:'#d1a60b',model:3,pos:[0,-26],pins:[...['L/R','WS','SCK'].map((n,i)=>[n,-4.4,-2.54+i*2.54]),...['GND','VDD','SD'].map((n,i)=>[n,4.4,-2.54+i*2.54])]},
 {id:'speaker',name:'喇叭',detail:'8Ω 0.5W · 接线预览',color:'#606b73',model:4,pos:[33,-24],pins:[['-',20,20],['+',23,20]]}
];
