...
const PAGES = {
  ...
  btn() {
    return `${hero("这是说话按键，不是 RST")}
      ...
      <p>对话模式里：GND 接蓝轨，SIG 接主板 0。现在还没有电池，要先用 USB 供电。配好网并检查钥匙以后，网页里点「开始听」；真机上才按这颗键。听的时候屏幕睁眼，想的时候眯眼，说的时候张嘴。教师台会写下短回答并用电脑喇叭出声；学生页只是练习，不会把声音发到网上。</p>
  ...
  faq() {
    return `<div class="kb-faq">
      ...
      <details><summary>金黄灯和青绿灯有什么不一样？</summary><p>金黄灯是这一步要接的两个孔，点了第一头也不会灭，要等这根线接完才换下一步。弱青绿灯是点了第一头以后，告诉你同一排 a–e / f–j，或同一侧电源轨是相通的。两个都亮时，先看金黄的。</p></details>
      <details><summary>零件可以拖动吗？已经接好的线能改吗？</summary><p>零件位置是写死的，三种模式都不能拖。只有「自己接线」可以点空孔接线、点电线删除，上一步 / 下一步也只改电线。「已经接好」和「对话」里零件和电线都固定，点了也不会改；左边零件盒也不能再加减。平移、缩放、3D、X-ray 还是可以的。</p></details>
      <details><summary>喇叭为什么不能直接接 ESP32？</summary><p>喇叭胃口很大，会把大脑的针脚累坏。一定要经过功放，并且只拧绿色端子。</p></details>
      <details><summary>积木和代码有什么不一样？</summary><p>「自己接线」和「已经接好」打开右边后，可以切「积木」或「代码」。积木给小朋友点着玩，引脚由程序自己写好，拼出来就能运行和烧录。代码给老师或 AI 写 Arduino。两种模式不会互相改写：切回去时，积木还是刚才那份。「对话」默认收起右边；打开后只有代码，没有积木。三个模式都可以点工具栏最右边，把右边栏收起来。</p></details>
